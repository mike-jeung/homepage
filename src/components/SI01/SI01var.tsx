...
//             timeline.current.to(refs.win1.current,{x:-300,duration:0.25,ease:"power1.in"},">");
//             timeline.current.to(refs.win2.current,{x:300,duration:0.25,ease:"power1.in"},">-0.25");
...
//             timeline.current.from(platters,{y:-100,stagger:0.2,duration:0.5});
            
//             timeline.current.addLabel("zoom");

//             timeline.current.fromTo(refs.bot.current, {strokeDashoffset:l, strokeDasharray:l, ease:"power4.out"}, {duration:1.5, strokeDashoffset:0})
//                 .fromTo(refs.top.current, {strokeDashoffset:l, strokeDasharray:l, ease:"power4.out"}, {duration:1.5, strokeDashoffset:0},"<");

//             timeline.current.fromTo(refs.dots.current,{opacity:1,x:-200},{x:200,duration:1},"<1.25");
                

//             timeline.current.to(refs.bot.current, {duration:1.5, strokeDashoffset:-l},"<0.75")
//                 .to(refs.top.current, {duration:1.5, strokeDashoffset:-l},"<");
            
//                 timeline.current.set(refs.dots.current,{opacity:0},">");
